...
# Amnah siddiqa as og june 04 2023; acquired this script solely from https://github.com/IOBR/IOBR/blob/905127ffa32aee5e1fa6c305c2e14e7c918a5967/R/CIBERSORT.R
# and is not responsible for any changes or distributions accredited with theis script; 
# people should acquire licensed version and use accrodingly 
